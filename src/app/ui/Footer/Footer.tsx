...
export function Footer() {
  return (
    <footer className={styles.footer}>
      <div className={styles.content}>
        ...
        <div className={styles.socialMedia}>
          ...
          <div className={styles.socialIcons}>
            ...
            <a href="https://t.me/rgk_afrodita">
              <Assets.TelegramIcon />
            </a>
      ...
      <div className={styles.subfooterVertical}>
        <div className={styles.subfooter}>
          <Assets.CIcon />
          <small>
            2024 Афродита 🤍 от <a href="https://roinext.marketing/">Roinext</a>
          </small>
        </div>
        <small>ООО &quot;Арго&quot; ИНН 2368003130 ОГРН 1122368000039</small>
      </div>
